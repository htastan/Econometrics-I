...
1. **Introduction**: 
    ...
    * Purpose and scope: [handout](Slide-Handouts/Handout-01-Introduction.pdf)
...
2. **Simple Regression Analysis - Part I**
    * Handout: [pdf](Slide-Handouts/Handout-02-Simple-Regression-Analysis-I.pdf)
...
3. **Simple Regression Analysis - Part II**
    * Handout: [pdf](Slide-Handouts/Handout-03-Simple-Regression-Analysis-II.pdf)
...
4. **Multiple Regression Analysis - Estimation**
    * Handout: [pdf](Slide-Handouts/Handout-04-Multiple-Regression-Analysis-Estimation.pdf)
...
5. **Multiple Regression Analysis - Inference: PART 1**
    * Handout: [pdf](Slide-Handouts/Handout-05-Multiple-Regression-Analysis-Inference.pdf)
...
6. **Multiple Regression Analysis - Inference: PART 2**
    * Handout: [pdf](Slide-Handouts/Handout-06-Multiple-Regression-Analysis-Inference-II.pdf)
...
7. **Asymptotic Properties of OLS**
    * Handout: [pdf](Slide-Handouts/Handout-07-Asymptotics.pdf)
...
8. **Further Topics in OLS regressions**
    * Handout: [pdf](Slide-Handouts/Handout-08-MLR-Further-Topics.pdf)
...
9. **Qualitative Explanatory Variables**
    * Handout: [pdf](Slide-Handouts/Handout-09-Qualitative-Variables.pdf)
    * Lab 10: [R applications](Labs/Lab-10-Dummy-Variables.html) | [.Rmd](Labs/Lab-10-Dummy-Variables.Rmd)

10. **Binary Dependent Variable**
    * Handout: [pdf](Slide-Handouts/Handout-10-Binary-Dependent-Variable.pdf)
...
11. **Heteroskedasticity**
    * Handout: [pdf](Slide-Handouts/Handout-11-Heteroscedasticity.pdf)
...
12. **Misspecification and Data Problems**
    * Handout: [pdf](Slide-Handouts/Handout-12-Misspecification-and-Data-Problems.pdf)
